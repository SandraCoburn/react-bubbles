...
To be able to have authorization to access protected sites.

- [ ] What steps can you take in your web apps to keep your data secure?

We can add an authorization header to requests to only allow acces if a token is retrieved.

- [ ] Describe how web servers work.

They store code for different websites to be shared across the world at all times.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Create when you Post, Read or Get, Update or Put, Delete,
